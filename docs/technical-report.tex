...
\paragraph{Messaging Feature}
\begin{itemize}
    \item \textbf{HTML and CSS:} The chat_window.html/dashboard.html files structure the message window page, displaying a chat window with messagess between you and a friend. The chat_window.html section css file styles the page, ensuring a consistent design with the rest of the application.
    \item \textbf{JavaScript:} The loadChat() function ...
\end{itemize}
