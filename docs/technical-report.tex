...
\begin{itemize}
    ...
    \item \textbf{JavaScript:} There is a JavaScript file, where the setting functions are implemented. There is a function is a function SoundDown() to control the sound up. This function is connected to a sound function in sound.js. SoundDown()  is responsible for bringing the sound down. These functions are connected to functions in the sound javascript file.
\end{itemize}
