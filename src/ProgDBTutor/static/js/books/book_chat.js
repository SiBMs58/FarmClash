...
let numberOfPapers = 7; // Total number of papers
    ...
    if(currentLocation < maxLocation) {
        switch(currentLocation) {
            ...
            case 7:
                ...
                cover2.style.zIndex = 7; // Update z-index for cover 2
    ...
    if(currentLocation > 1) {
        switch(currentLocation) {
            case 2:
                ...
                cover1.style.zIndex = 7; // Update z-index for cover 1
                break;
            case 3:
                paper1.classList.remove("flipped"); // Unflip paper 1
                paper1.style.zIndex = 6; // Update z-index for paper 1
                break;
            case 4:
                paper2.classList.remove("flipped"); // Unflip paper 2
                paper2.style.zIndex = 5; // Update z-index for paper 2
                break;
            case 5:
            ...
            case 6:
                ...
                paper4.style.zIndex = 3; // Update z-index for paper 4
                break;
            case 7:
                paper5.classList.remove("flipped"); // Unflip paper 5
                paper5.style.zIndex = 2; // Update z-index for paper 5
                break;
            case 8:
                openBook(); // Open the bookChat
