...
def register():
    ...
    if request.method == 'POST':
        ...
        if success:
            ...
            gameservices = GameServices(user_data_access, current_app.config.get('map_data_access'), current_app.config.get('tile_data_access'),current_app.config.get('resource_data_access'),current_app.config.get('building_data_access'))
